...
class _AdPostState extends State<AdPost> {
  ...
  Future<void> _postSparePart() async {
    try {
      ...
      List<String> downloadUrl = await _uploadImages(_images);
      print("sparepartimage uploaded successfully. Download URL: $downloadUrl");

      await widget.apiService.postSparePart(
